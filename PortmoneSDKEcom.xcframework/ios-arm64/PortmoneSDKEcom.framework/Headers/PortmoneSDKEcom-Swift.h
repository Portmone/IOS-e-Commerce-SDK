...
/// public init
- (nonnull instancetype)initWithView:(UIView * _Nonnull)view cardTextField:(UITextField * _Nonnull)cardTextField expireTextField:(UITextField * _Nonnull)expireTextField cvvTextField:(UITextField * _Nonnull)cvvTextField continueButton:(UIButton * _Nonnull)continueButton flowType:(enum MerchantViewFlowType)flowType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
